...
![Mean Quality score (0-37) across all base positions in the read with error bars and color coded regions to denote high, potentially problematic, and problematic quality scores in Cco_com123_EO_6cm_1_1.](figures/Cco_com123_EO_6cm_1_1_bq.png)

![Percent of Unknown Reads (N) by base position in read of Cco_com123_EO_6cm_1_1.](figures/Cco_com123_EO_6cm_1_1n.png)
...
![Mean Quality score (0-37) across all base positions in the read with error bars and color coded regions to denote high, potentially problematic, and problematic quality scores in Cco_com123_EO_6cm_1_2.](figures/Cco_com123_EO_6cm_1_2_bq.png)

![Percent of Unknown Reads (N) by base position in read of Cco_com123_EO_6cm_1_2.](figures/Cco_com123_EO_6cm_1_2n.png)
...
![Mean Quality score (0-37) across all base positions in the read with error bars and color coded regions to denote high, potentially problematic, and problematic quality scores in Crh_rhy116_EO_adult_3_1_bq.](figures/Crh_rhy116_EO_adult_3_1_bq.png)

![Percent of Unknown Reads (N) by base position in read of Crh_rhy116_EO_adult_3_1n.png.](figures/Crh_rhy116_EO_adult_3_1n.png)
...
![Mean Quality score (0-37) across all base positions in the read with error bars and color coded regions to denote high, potentially problematic, and problematic quality scores in Crh_rhy116_EO_adult_3_2_bq.](figures/Crh_rhy116_EO_adult_3_2_bq.png)

![Percent of Unknown Reads (N) by base position in read of Crh_rhy116_EO_adult_3_2n.png.](figures/Crh_rhy116_EO_adult_3_2n.png)
...
![Mean quality score (30 - 37) by base position in read, 0 indexed. Each bin is representative of a single base within the read.](figures/Cco_1_1.png)

### Overall data quality of libraries:

#### Using the `FASTQC` [documentation](https://www.bioinformatics.babraham.ac.uk/projects/FASTQC/Help/3%20Analysis%20Modules/) results from FASATQC were interpreted as follows:
...
![Log scaled distribution of Cco_com123_EO_6cm_1 read lenghts (bp). Red bars represent read1 (R1) counts while blue bars represent read2 (R2) counts. Bin width of combined reads (read1 and read2) is representative of read length bins.](figures/Cco_com123_EO_6cm_1_readlen.png) ![Log scaled distribution of Crh_rhy116_EO_adult_3 read lenghts (bp). Orange bars represent read1 (R1) counts while purple bars represent read2 (R2) counts. Bin width of combined reads (read1 and read2) is representative of read length bins.](figures/Crh_rhy116_EO_adult_3_readlen.png)
